...
FFIs like reticulate\footnote{\url{https://CRAN.R-project.org/package=reticulate}} or rpy2\footnote{\url{https://github.com/rpy2/rpy2}} allow 
...
but was not fully taken up by the community. The AnnData HDF5-based\footnote{\url{https://github.com/HDFGroup/hdf5}} H5AD format has 
become the de facto standard for Python users and in some public repositories while R objects are
commonly saved as non-interoperable binary Rds files. To address this, packages such as rds2py\footnote{\url{https://github.com/BiocPy/rds2py}}, alabaster \citep{alabaster} and dolomite\footnote{\url{https://github.com/ArtifactDB/dolomite-base}} provide ways to read and write SingleCellExperiment objects in Python. 
SeuratDisk\footnote{\url{https://github.com/mojaveazure/seurat-disk}} provides a way to save Seurat objects as interoperable HDF5 files. 
