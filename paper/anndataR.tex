...
\documentclass[unnumsec,webpdf,modern,large,namedate]{oup-authoring-template}% author year citations
...
\author[1,2,3,4\textsuperscript{\textdagger}$\ast$]{Robrecht Cannoodt\ORCID{0000-0003-3641-729X}}
\author[5]{Martin Morgan\ORCID{0000-0002-5874-8148}}
\author[]{scverse core}
\author[6,7]{Isaac Virshup\ORCID{0000-0002-1710-8945}}
\author[1,2]{Chananchida Sang-Aram\ORCID{0000-0002-0922-0822}}
\author[8,9]{Danila Bredikhin\ORCID{0000-0001-8089-6983}}
\author[10]{Brian Schilder\ORCID{0000-0001-5949-2191}}
...
\address[3]{Data Intuitive, Lebbeke, Belgium}
\address[4]{Edaro, Destelbergen, Belgium}
\address[5]{Department of Biostatistics and Bioinformatics, Roswell Park Comprehensive Cancer Center}
\address[6]{Institute of Computational Biology, Helmholtz, Center Munich, Munich, Germany}
\address[7]{Chan Zuckerberg Initiative, Redwood City, CA, USA}

\address[8]{Department of Genetics, Stanford University, Stanford, CA, USA}
\address[9]{scverse}
\address[10]{Department of Brain Sciences, Faculty of Medicine, Imperial College London, London, UK}


\corresp[\textsuperscript{\textdagger}]{These authors contributed equally. }
\corresp[$\ast$]{Corresponding author: \href{email:robrecht.cannoodt@gmail.com}{robrecht.cannoodt@gmail.com}}
...
\textbf{Availability:} anndataR’s source code is available on GitHub at \href{https://github.com/scverse/anndataR/}{scverse/anndataR} under the MIT license. It is compatible with R version 4.5, has been archived at \href{https://doi.org/10.5281/zenodo.18775712}{10.5281/zenodo.18775712} and included within Bioconductor: \href{https://doi.org/doi:10.18129/B9.bioc.anndataR}{10.18129/B9.bioc.anndataR}. Installation instructions and tutorials can be found in the online documentation at \href{https://anndatar.scverse.org/}{anndatar.scverse.org}. Issues can be reported at the \href{https://github.com/scverse/anndataR/}{GitHub repository}. Code to reproduce the analyses performed can be found on GitHub at \href{https://github.com/LouiseDck/anndataR-paper/}{LouiseDck/anndataR-paper}, archived at \href{https://doi.org/10.5281/zenodo.18792241}{10.5281/zenodo.18792241}.\\
\textbf{Contact:} \href{mailto:robrecht.cannoodt@gmail.com}{robrecht.cannoodt@gmail.com}\\
...
FFIs like reticulate (\url{https://CRAN.R-project.org/package=reticulate}) or rpy2 (\url{https://github.com/rpy2/rpy2}) allow 
...
Loom & R, Python &  & Loom (h5) &  \\ \hline
scDIOR \citep{scdior} & R, Python &  & scDIOR (h5) & AnnData$\leftrightarrow$SCE \ AnnData$\leftrightarrow$Seurat \\ \hline
BiocPy with rds2py & Python &  &  &  \\ \hline
alabaster \citep{alabaster} dolomite & R, Python &  & HDF5, csv &  \\ \hline
SeuratDisk & R &  & h5Seurat & Seurat$\leftrightarrow$AnnData \\ \hline
...
schard & R &  &  & Converts between AnnData, SCE and Seurat\tablefootnote{Incomplete: only reads and converts X, obs, var, obsm} \\ \hline
anndataR (this paper) & R &  &  & Converts between AnnData, SCE and Seurat \\ \hline
SCUBA \citep{scuba} & R & \checkmark & provides API &  \\ \hline
scKirby & R & \checkmark &  & Converts between AnnData, SCE, Seurat and Loom\tablefootnote{Combines conversion functionality from other packages} \\ \thickhline
\end{tabular}
...
but was not fully taken up by the community. The AnnData HDF5-based (\url{https://github.com/HDFGroup/hdf5}) H5AD format has 
become the de facto standard for Python users and in some public repositories while R objects are
commonly saved as non-interoperable binary Rds files. To address this, packages such as rds2py (\url{https://github.com/BiocPy/rds2py}), alabaster \citep{alabaster} and dolomite (\url{https://github.com/ArtifactDB/dolomite-base}) provide ways to read and write SingleCellExperiment objects in Python. 
SeuratDisk (\url{https://github.com/mojaveazure/seurat-disk}) provides a way to save Seurat objects as interoperable HDF5 files. 
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\textwidth, alt={Overview showing anndataR features and an example workflow, detailing how anndataR can be used during analysis.}]{figures/anndataR_figure.pdf}
