...
\textbf{Availability:} anndataR’s source code is available on GitHub at \href{https://github.com/scverse/anndataR/}{scverse/anndataR} under the MIT license. It is compatible with R version 4.5, has been archived at \href{https://doi.org/10.5281/zenodo.15689523}{10.5281/zenodo.15689523} and included within Bioconductor: \href{https://doi.org/doi:10.18129/B9.bioc.anndataR}{10.18129/B9.bioc.anndataR}. Installation instructions and tutorials can be found in the online documentation at \href{https://anndatar.scverse.org/}{anndatar.scverse.org}. Issues can be reported at the \href{https://github.com/scverse/anndataR/}{GitHub repository}. Code to reproduce the analyses performed can be found on GitHub at \href{https://github.com/LouiseDck/anndataR-paper/}{LouiseDck/anndataR-paper}.\\
...
(Supplementary Table 1) with comparable runtime performance to similar tools
