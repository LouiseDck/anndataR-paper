...
# Warm up
message("Warming up zellkonverter (R) ...")
...
write.csv(timings, file.path(out_dir, "zellkonverter_R.csv"), row.names = FALSE)
message("Saved ", file.path(out_dir, "zellkonverter_R.csv"))
