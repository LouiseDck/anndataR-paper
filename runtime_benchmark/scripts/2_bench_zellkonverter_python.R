...
# Warm up (also initialises the basilisk Python environment)
message("Warming up zellkonverter (Python) ...")
...
write.csv(timings, file.path(out_dir, "zellkonverter_python.csv"), row.names = FALSE)
message("Saved ", file.path(out_dir, "zellkonverter_python.csv"))
